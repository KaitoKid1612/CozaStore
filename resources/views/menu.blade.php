    ...
    <div class="bg0 m-t-23 p-b-140 p-t-80">
        <div class="container">
            <div class="flex-w flex-sb-m p-b-52">
                ...
                <!-- Search product -->
                <form class="dis-none panel-search w-full p-t-10 p-b-15" type="get" action="{{url('/search')}}">
                    <div class="bor8 dis-flex p-l-15">
                        <button class="size-113 flex-c-m fs-16 cl2 hov-cl1 trans-04" type="submit">
                            <i class="zmdi zmdi-search"></i>
                        </button>

                        <input class="mtext-107 cl2 size-114 plh2 p-r-15" id="keyword" name="query" type="search"  placeholder="Search">
                    </div>
                </form>
