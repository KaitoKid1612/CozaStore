...
@section('content')
    ...
    <section class="sec-product-detail bg0 p-t-65 p-b-60">
        ...
        <div class="fb-comments" style="text-align:center" data-href="http://127.0.0.1:8000/san-pham/{{$product->id}}-{{Str::slug($product->name, '-')}}.html" data-width="" data-numposts="10"></div>
        <div class="fb-like" data-href="http://127.0.0.1:8000/san-pham/{{$product->id}}-{{Str::slug($product->name, '-')}}.html" data-width="" data-layout="standard" data-action="like" data-size="large" data-share="true"></div>
